...
class Optimizer:
    ...
    def run(self, args):
        ...
        validation_history = optimizer.validate()
        return best_config, optimizer.get_runhistory(), optimizer.get_trajectory(), validation_history
...
def main():
    ...
    best_config, history, trajectory, val_history = Optimizer(args.dataset, args.n_events).run(args)
